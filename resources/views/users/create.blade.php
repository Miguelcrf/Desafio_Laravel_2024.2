...
<div class="flex justify-center items-center w-full h-full">
        <div class="flex flex-col bg-[#ff1111] rounded-lg w-3/5 h-full">
            ...
            <label for="text2"> EMAIL:   
                ...
                <input type="text" name="endereço" placeholder="Endereço" id="text4">
                </label> 
                <label for="text5"> CPF:   
                <input type="text" name="cpf" placeholder="CPF" id="text5">
                </label> 
                <label for="text6"> TELEFONE:   
                <input type="text" name="telefone" placeholder="Telefone de contato" id="text6">
                </label> 
                <label for="text7"> DATA DE NASCIMENTO:   
                <input type="date" name="nascimento" placeholder="Data de nascimento" id="text7">
                </label> 
